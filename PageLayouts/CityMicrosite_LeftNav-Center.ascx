...
<section id="contentArea" class="layoutContainer">
  ...
  <div class="siteBounds leftNavWrapper">
    <div id="leftZone" class="side"> <a name="Nav" id="Nav" class="skipNav">Sub Navigation</a> <a href="#MainContent" class="skipNav skipSubNav">Skip to Main Content</a>
      <nav>
        <cms:DisplayNavigation id="contentNav" Zone="Left" Xslt="cityMicrosite_leftNav.xsl" MaximumTreeLevels="8" runat="server"/>
      </nav>
