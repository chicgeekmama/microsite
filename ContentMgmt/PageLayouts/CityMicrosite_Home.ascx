...
<section id="contentArea" class="layoutContainer homeLayoutContainer">
    <div id="topZone">
        <cms:CenterContent id="topContent" Zone="Top" ParseStripes="false" runat="server" />
    </div>
	<a name="Nav" id="Nav" class="skipNav">Main Content</a>
    <div id="centerZone">
        <cms:CenterContent id="centerContent" Zone="Center" ParseStripes="true" DefaultStripe="StripeDefault" StripePrefix="Stripe" WrapperClass="siteBounds" runat="server" />
        <div class="siteBounds">
